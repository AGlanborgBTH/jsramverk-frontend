...
{#if page == 0}
    <Form title="Register" alter="Login" bind:email bind:password bind:handleSubmit bind:swapPage />
{:else}
    <Form title="Login" alter="Register" bind:email bind:password bind:handleSubmit bind:swapPage />
{/if}
